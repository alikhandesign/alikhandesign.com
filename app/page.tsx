...
export default function Home() {
  return (
    <main>
      <section style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center', padding: '5rem 3rem 4rem' }}>
          <div>
            <p className="eyebrow" style={{ marginBottom: '1.25rem' }}>Senior Product Designer & Researcher</p>
            <h1 className="font-serif" style={{ fontSize: '3.2rem', lineHeight: 1.1, color: 'var(--text)', marginBottom: '1.25rem', fontWeight: 400 }}>
          ...
          <div style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
            <Image src="/images/ali.jpg" alt="Ali Khan smiling with his dog Chappie in a park" width={340} height={400} style={{ objectFit: 'cover', objectPosition: 'center top', borderRadius: 'var(--radius)' }} priority />
      ...
      <div style={{ borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)', padding: '1.5rem 3rem', display: 'flex', justifyContent: 'center', gap: '3rem', flexWrap: 'wrap' as const, background: 'var(--bg)' }}>
      ...
      <section style={{ padding: '5rem 3rem', maxWidth: 'var(--max-w)', margin: '0 auto' }}>
        <p className="section-label">Impact</p>
        <h2 className="font-serif" style={{ fontSize: '2.2rem', fontWeight: 400, marginBottom: '3rem', lineHeight: 1.15 }}>Work that moves the needle.</h2>
      ...
      <section style={{ padding: '5rem 3rem', maxWidth: 'var(--max-w)', margin: '0 auto' }}>
        ...
        <h2 className="font-serif" style={{ fontSize: '2.2rem', fontWeight: 400, marginBottom: '3rem', lineHeight: 1.15 }}>Research in action.</h2>
      ...
      <section style={{ background: 'var(--dark-bg)', padding: '4rem 3rem' }}>
        <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
          <div>
