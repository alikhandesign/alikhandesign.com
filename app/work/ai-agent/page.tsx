  ...
  return (
    <div style={{ maxWidth: 680 }}>
      ...
      <section id="the-reframe" style={{ marginBottom: '4rem', scrollMarginTop: '5rem' }}>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85, marginBottom: '1.25rem' }}>The obvious framing was: "Can AI do this faster?" But that wasn't the right question. The real problem was the Expert Gap — the mismatch between the people doing the categorization and the product knowledge required to do it accurately. A faster version of the same process would just produce wrong answers more quickly.</p>
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85 }}>The right question was: "Can AI close the Expert Gap while handling sensitive healthcare data responsibly?" That reframe changed everything about how I designed the system.</p>
      </section>
      ...
      <section id="the-compliance-challenge" style={{ marginBottom: '4rem', scrollMarginTop: '5rem' }}>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85, marginBottom: '1.25rem' }}>The first design challenge wasn't building anything. It was earning the right to build. I ran workshops with Legal and Compliance to define exactly what constituted PII and PHI in our context and where the line was that the system could not cross.</p>
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85 }}>From those workshops, I engineered a layered redaction approach. Qualtrics queries handled structured patterns. An LLM-based redaction layer caught names and edge cases. Legal signed off before production deployment. That sign-off wasn't just a checkbox — it was what made the whole project possible.</p>
      </section>
      ...
      <section id="the-build" style={{ marginBottom: '4rem', scrollMarginTop: '5rem' }}>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85, marginBottom: '1.25rem' }}>I started with Dataverse as the single source of truth — a structured taxonomy table grounded in WTW's specific product documentation and internal knowledge base. On top of that, two categorization approaches worked in parallel: Qualtrics Text IQ for known patterns, and Microsoft CoPilot Studio (GPT) for ambiguous cases requiring intent interpretation.</p>
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85 }}>Power Automate connected the pipeline in real time. I also built a conversational interface in Teams so stakeholders could ask direct questions — "What were the top three complaints from Medicare users this week?" — and get instant synthesized answers.</p>
      </section>
      ...
      <section>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85, marginBottom: '1.25rem' }}>The interface wasn't the hard part. The hard part was making AI trustworthy enough that people were willing to delegate important work to it. That required compliance-first thinking before the first line of code, a validation methodology rigorous enough to change a skeptic's mind, and fallback logic so humans stayed in the loop where they needed to be.</p>
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85 }}>If I were starting over, I'd build validation into day one rather than week three. The big takeaway: with agentic AI, the design challenge isn't the interface. It's building trust through validation, transparency, and continuous improvement.</p>
      </section>
    </div>
  )
}
