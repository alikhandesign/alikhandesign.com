  ...
  return (
    <div style={{ maxWidth: 680 }}>
      ...
      <section id="the-research" style={{ marginBottom: '4rem', scrollMarginTop: '5rem' }}>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85, marginBottom: '1.25rem' }}>I ran a dual-track research initiative. First, FullStory sessions revealed a dense cluster of rage clicks at exactly the plan type selector — users weren't just confused, they were frustrated. Second, moderated user interviews confirmed the core insight: users didn't want to select a plan category. They wanted to see what was available for someone like them.</p>
      </section>
      ...
      <section id="the-design" style={{ marginBottom: '4rem', scrollMarginTop: '5rem' }}>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85, marginBottom: '1.25rem' }}>The redesigned selector led with a simple question: who are you shopping for? From there, users provided age and zip code, and the system handled eligibility filtering entirely in the background. I also designed an "Escape Hatch" for users who already knew their plan type, satisfying sophisticated users without making that the default path for everyone.</p>
      </section>
      ...
      <section>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85, marginBottom: '1.25rem' }}>The hardest part of this project wasn't the design. It was dismantling a belief that had calcified into institutional fact. The "Product-First mandate" everyone cited turned out to be an assumption nobody had ever verified. That's a lesson I carry into every project now: question the constraints before you design within them.</p>
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--color-text-mid)', lineHeight: 1.85 }}>If I were doing this project again, I'd move to stakeholder alignment earlier. And I'd push harder for qualitative follow-up research after launch — the metrics told us what changed, but not how users felt about the new experience.</p>
      </section>
    </div>
  )
}
