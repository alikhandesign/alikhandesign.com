...
const caseStudies = [
  {
    ...
    outcomes: [
      ...
      { val: '1 day → min', label: 'Synthesis time reduction' },
    ],
    disciplines: 'AI Design · Agentic Workflow · Qualitative Research',
    href: '/work/ai-agent',
  },
  {
    ...
    disciplines: 'UX Research · Product Design · Stakeholder Strategy',
  ...
  },
  {
    ...
    desc: 'Led mixed-methods research to uncover why members declined free in-home health evaluations — findings that directly informed a trust-first scheduling portal redesign, shifting from a callback-request model to real-time self-scheduling.',
    outcomes: [
      { val: '73 NPS', label: 'Post-visit satisfaction' },
      { val: '3.5M+', label: 'Annual IHEs completed' },
      { val: '6', label: 'Barrier categories identified' },
    ],
    disciplines: 'Mixed-Methods Research · UX Design · Trust Strategy',
...
const projects = [
  {
    ...
    desc: 'A qualitative deep dive into how Medicare enrollees navigate dental, vision, and hearing coverage — identifying comprehension gaps and friction points to streamline benefit selection.',
  ...
  },
  {
    ...
    desc: 'Designed a native iOS clinical application for Vivio — a non-invasive heart failure diagnostic tool — with a complete design system and 20+ error states built for clinical environments.',
    href: '/work/vivio',
  },
  {
    ...
    desc: 'Led a full brand refresh in partnership with W2O Group, evolving Signify Health\'s visual identity to reflect its expanded mission — resulting in a 50% increase in total website traffic.',
    href: '/work/signify-rebrand',
  },
  {
    title: 'LLM Prompt Engineering for Website Audits',
    company: 'Willis Towers Watson',
    tags: ['AI Workflow', 'AI Design'],
    desc: 'Engineered a structured prompt framework for using large language models to conduct UX website audits — systematizing a process that previously relied entirely on manual heuristic review.',
    href: '/work/llm-prompts',
  },
  {
    title: 'Design Handoff Checklist',
    company: 'Willis Towers Watson',
    tags: ['Process Design', 'Workflow Optimization'],
    desc: 'Developed a comprehensive design-to-development handoff checklist that reduced miscommunication cycles and ensured consistent, spec-complete delivery across product and engineering teams.',
    href: '/work/design-handoff',
  },
]
    ...
    <main>
      ...
      <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }}>
        <header style={{ padding: '3.5rem 3rem 2.5rem', borderBottom: '1px solid var(--border)' }}>
          ...
          <h1 className="font-serif" style={{ fontSize: '2.8rem', fontWeight: 400, lineHeight: 1.1, marginBottom: '0.75rem' }}>My Work</h1>
          <p style={{ fontSize: 16, color: 'var(--text-muted)', lineHeight: 1.6, maxWidth: 580 }}>
            10+ years of product design and UX research — from AI-native research pipelines to zero-to-one product ecosystems.
          </p>
        </header>
      </div>
      ...
      <section style={{ padding: '4rem 3rem', maxWidth: 'var(--max-w)', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          {caseStudies.map(cs => (
            <Link key={cs.title} href={cs.href} style={{
              background: 'var(--surface)', border: '1px solid var(--border)',
              borderRadius: 'var(--radius)', overflow: 'hidden',
              textDecoration: 'none', color: 'inherit',
              display: 'grid', gridTemplateColumns: '320px 1fr',
            }} className="work-card">
              <div style={{ background: 'var(--border)', minHeight: 220, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, color: 'var(--text-muted)', letterSpacing: '0.05em', textTransform: 'uppercase' as const, flexShrink: 0 }}>
                Project Preview
              </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.25rem' }}>
          {projects.map(p => (
            <Link key={p.title} href={p.href} style={{
              ...
              <div style={{ width: '100%', height: 160, background: 'var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, color: 'var(--text-muted)', letterSpacing: '0.05em', textTransform: 'uppercase' as const }}>
                Project Preview
              </div>
