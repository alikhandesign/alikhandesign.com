...
export default function Page() {
  ...
  >
    <PasswordGate
      type="project"
      title="Want to see the research and the mockups behind it?"
      description="The full gallery — the discovery research that surfaced the problem, the ad hoc mockup annotations the protocol replaced, the responsive breakpoints it produced, and adoption feedback from designers, developers, and QA."
      inside={['Discovery research: status-quo and mobile-handling audit boards', 'Annotated handoff mockups with redline notes', 'Responsive breakpoints documented in Figma', 'Before/after adoption feedback from designers, devs, and QA']}
    >
      <GatedGallery />
    </PasswordGate>
  </ProjectPage>
