...
const patterns = [
  {
    ...
    svg: (
      <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
        <rect x="8" y="28" width="104" height="24" rx="4" fill="var(--accent-bg)" stroke="var(--accent)" strokeWidth="1" opacity="0.4"/>
        <circle cx="24" cy="40" r="4" fill="var(--accent)" opacity="0.5"/>
        <circle cx="38" cy="40" r="4" fill="var(--accent)" opacity="0.3"/>
        <circle cx="52" cy="40" r="4" fill="var(--accent)" opacity="0.15"/>
        <rect x="64" y="36" width="32" height="8" rx="2" fill="var(--accent)" opacity="0.2"/>
        <rect x="8" y="60" width="60" height="4" rx="2" fill="var(--accent)" opacity="0.15"/>
        <rect x="8" y="60" width="36" height="4" rx="2" fill="var(--accent)" opacity="0.5"/>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
        <rect x="8" y="8" width="104" height="6" rx="2" fill="var(--accent)" opacity="0.3"/>
        <rect x="8" y="22" width="80" height="3" rx="1.5" fill="var(--border)"/>
        <rect x="8" y="30" width="96" height="3" rx="1.5" fill="var(--border)"/>
        <rect x="8" y="38" width="60" height="3" rx="1.5" fill="var(--accent)" opacity="0.2"/>
        <rect x="72" y="50" width="40" height="20" rx="3" fill="var(--accent-bg)" stroke="var(--accent)" strokeWidth="1" opacity="0.5"/>
        <rect x="76" y="55" width="28" height="3" rx="1.5" fill="var(--accent)" opacity="0.3"/>
        <rect x="76" y="62" width="20" height="3" rx="1.5" fill="var(--accent)" opacity="0.2"/>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
        <rect x="8" y="8" width="68" height="64" rx="3" fill="var(--accent-bg)" stroke="var(--accent)" strokeWidth="1" opacity="0.4"/>
        <rect x="82" y="8" width="30" height="64" rx="3" fill="var(--warm-75)" stroke="var(--border)" strokeWidth="1"/>
        ...
        <circle cx="60" cy="27" r="4" fill="var(--accent)" opacity="0.7"/>
        <rect x="86" y="16" width="20" height="12" rx="2" fill="var(--surface)" stroke="var(--accent)" strokeWidth="1" opacity="0.5"/>
        <rect x="86" y="32" width="20" height="12" rx="2" fill="var(--surface)" stroke="var(--border)" strokeWidth="1"/>
        <rect x="86" y="48" width="20" height="12" rx="2" fill="var(--surface)" stroke="var(--border)" strokeWidth="1"/>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
        ...
        <rect x="14" y="14" width="6" height="6" rx="1" fill="var(--accent)" opacity="0.4"/>
        ...
        <rect x="11" y="36" width="3" height="36" rx="1.5" fill="var(--accent)" opacity="0.6"/>
        ...
        <rect x="20" y="59" width="40" height="3" rx="1.5" fill="var(--accent)" opacity="0.3"/>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
        ...
        <rect x="100" y="14" width="6" height="14" rx="2" fill="var(--accent)" opacity="0.3"/>
        <rect x="8" y="44" width="104" height="28" rx="3" fill="var(--surface)" stroke="var(--accent)" strokeWidth="1.5" opacity="0.5"/>
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
        ...
        <rect x="8" y="56" width="104" height="16" rx="3" fill="var(--accent-bg)" stroke="var(--accent)" strokeWidth="1" opacity="0.6"/>
