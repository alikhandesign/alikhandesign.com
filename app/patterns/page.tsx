  ...
  return (
    <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }}>
      <div className="page-header">
        ...
        <h1 className="font-serif" style={{ fontSize: 'var(--color-text-4xl)', fontWeight: 400, lineHeight: 'var(--line-height-tight)', marginBottom: 'var(--space-4)', color: 'var(--color-text)' }}>
          AI Interface Patterns
        </h1>
        <p style={{ fontSize: 'var(--color-text-md)', color: 'var(--color-text-muted)', lineHeight: 'var(--line-height-normal)', maxWidth: 640 }}>
            ...
            <a key={p.slug} href={`/patterns/${p.slug}`} style={{ textDecoration: 'none' }}>
              <div className="work-card" style={{
                ...
                <div style={{ padding: 'var(--space-5)', display: 'flex', flexDirection: 'column', gap: 'var(--space-3)', flex: 1 }}>
                  <h2 style={{ fontSize: 'var(--color-text-lg)', fontWeight: 'var(--font-weight-semibold)', color: 'var(--color-text)', lineHeight: 'var(--line-height-tight)' }}>
                    {p.title}
                  </h2>
                  <p style={{ fontSize: 'var(--color-text-sm)', color: 'var(--color-text-muted)', lineHeight: 'var(--line-height-normal)', flex: 1 }}>
                    {p.desc}
                  </p>
                  <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                    <span style={{ fontSize: 'var(--color-text-sm)', color: 'var(--color-accent)', fontWeight: 'var(--font-weight-medium)' }}>
                      View pattern →
                    </span>
                  </div>
                </div>
