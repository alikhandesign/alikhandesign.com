...
export default function Page() {
  ...
  return (
    <PatternShell
      title="Error States"
      category="Pattern 6"
      problem="Silent failures — hung states, incomplete responses — are the most dangerous errors because users cannot calibrate against failures they cannot see."
      activeTab={activeTab}
