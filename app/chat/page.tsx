      ...
      <div style={{
        ...
        <header className="page-header" style={{ borderBottom: '1px solid var(--color-border)' }}>
          <nav style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
            <Link href="/" style={{ fontSize: 'var(--color-text-base)', color: 'var(--color-text-muted)', textDecoration: 'none' }}>Home</Link>
            <span style={{ color: 'var(--color-border-mid)' }}>›</span>
            <span style={{ fontSize: 'var(--color-text-base)', color: 'var(--color-text)', fontWeight: 500 }}>Ask Ali</span>
          </nav>

          <p className="eyebrow">Portfolio Assistant</p>
          <h1 className="font-serif" style={{ fontSize: 'var(--color-text-4xl)', fontWeight: 400, lineHeight: 1.1, marginBottom: '0.5rem' }}>
            Ask Ali anything.
          </h1>
          <p style={{ fontSize: 'var(--color-text-base)', color: 'var(--color-text-muted)', lineHeight: 1.6, maxWidth: 520, marginBottom: 'var(--space-4)' }}>
          ...
          <div style={{ position: 'relative', display: 'inline-block' }}>
            {!unlocked ? (
              <button
                ...
                style={{
                  ...
                  fontSize: 'var(--color-text-sm)', color: 'var(--color-text-muted)',
              ...
              <span style={{
                display: 'inline-flex', alignItems: 'center', gap: 6,
                fontSize: 'var(--color-text-sm)', color: '#4A6130',
              }}>
                <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                  <rect x="3" y="7" width="10" height="8" rx="1.5" stroke="currentColor" strokeWidth="1.5"/>
            ...
            {showUnlock && !unlocked && (
              ...
              >
                <p style={{ fontSize: 'var(--color-text-base)', fontWeight: 500, marginBottom: '0.4rem' }}>Enter access code</p>
                <p style={{ fontSize: 'var(--color-text-xs)', color: 'var(--color-text-muted)', marginBottom: 'var(--space-4)', lineHeight: 1.6 }}>
                  Don't have a code?{' '}
                  <button
                    ...
                    style={{
                      ...
                      fontSize: 'var(--color-text-xs)', padding: 0,
                    }}
                  >
                    Request access →
                  </button>
                ...
                {passwordError && (
                  <p style={{ fontSize: 'var(--color-text-xs)', color: 'var(--color-accent-dark)', marginTop: '0.4rem' }}>
        ...
        >
          ...
          {showWarn && (
            <div style={{
              ...
              fontSize: 'var(--color-text-xs)', color: '#92600A',
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 'var(--color-text-xs)', textDecoration: 'underline', padding: 0,
                }}
              >
                Contact Ali
              </button>
          ...
          {showLimit && (
            <div style={{
              ...
              fontSize: 'var(--color-text-xs)', color: 'var(--color-accent)',
              marginBottom: 'var(--space-4)',
            }}>
