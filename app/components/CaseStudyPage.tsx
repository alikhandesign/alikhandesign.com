...
export default function CaseStudyPage({
  title, company, tags, hook, metrics, details, sections, unlocked,
  heroImage, heroImageAlt = 'Case study hero image', children, cta, next,
}: CaseStudyPageProps) {
    ...
    <main>
      ...
      <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }}>
        ...
        <header style={{ padding: '2.5rem 3rem 3rem' }}>
          ...
          <h2 className="font-serif page-title-lg" style={{
            fontSize: 'var(--font-size-4xl)', fontWeight: 400,
            lineHeight: 1.1, marginBottom: 'var(--space-2)',
          }}>
            {title}
          </h2>
          <p style={{
            fontSize: 'var(--font-size-xs)', color: 'var(--color-text-muted)',
            letterSpacing: 'var(--letter-spacing-sm)', marginBottom: 'var(--space-6)',
          }}>
            {company}
          </p>
          <p style={{
            fontSize: 'var(--font-size-base)', color: 'var(--color-text)',
        ...
        {metrics && metrics.length > 0 && (
          <div style={{ padding: '0 3rem 3rem', display: 'flex', gap: 'var(--space-12)', flexWrap: 'wrap' as const }}>
            {metrics.map(m => (
      ...
      <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }}>
        <div className="next-project">
          <div>
            <p style={{
              fontSize: 'var(--font-size-xs)', letterSpacing: 'var(--letter-spacing-lg)',
