        ...
        <ul className="nav-links" style={{ display: 'flex', listStyle: 'none' }}>
          ...
          <li>
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--color-accent)', fontWeight: 500, fontFamily: 'var(--font-sans)', fontSize: 'var(--color-text-base)', letterSpacing: 'var(--letter-spacing-sm)', padding: 0 }}
            >Let's Talk</button>
          </li>
        </ul>
      </nav>
