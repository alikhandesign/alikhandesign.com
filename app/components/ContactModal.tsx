        ...
        <div style={{ padding: 'var(--space-6)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 'var(--space-5)' }}>
            <div>
              ...
              <h2 className="font-serif" style={{ fontSize: 'var(--color-text-2xl)', fontWeight: 400, color: 'var(--color-text)', lineHeight: 1.2, margin: 0 }}>
                Let's work together.
              </h2>
            </div>
            <button
          ...
          <p style={{ fontSize: 'var(--color-text-base)', color: 'var(--color-text-muted)', lineHeight: 1.6, marginBottom: 'var(--space-6)' }}>
          ...
          <div style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: 'var(--radius)', padding: '0.75rem var(--space-4)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '0.5rem', marginBottom: 'var(--space-4)' }}>
            <span style={{ fontSize: 'var(--color-text-sm)', color: 'var(--color-text)', fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>ali@alikhandesign.com</span>
            <button
              onClick={handleCopy}
              style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6, fontSize: 'var(--color-text-xs)', color: copied ? 'var(--color-accent)' : 'var(--color-text-muted)', fontWeight: 500, fontFamily: 'var(--font-sans)', padding: '8px 4px', transition: 'color var(--transition-base)', minHeight: 44, flexShrink: 0 }}
            >
              {copied ? (
          ...
          <div style={{ borderTop: '1px solid var(--color-border)', paddingTop: 'var(--space-4)', display: 'flex', justifyContent: 'center', gap: 'var(--space-6)' }}>
            <a
              ...
              style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 'var(--color-text-base)', color: 'var(--color-text-muted)', textDecoration: 'none', fontWeight: 500, minHeight: 44, padding: '8px 4px' }}
            >
