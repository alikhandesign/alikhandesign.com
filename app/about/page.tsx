    ...
    <main>
      <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }}>
        <header className="page-header">
          ...
          <h1 className="font-serif page-title-lg" style={{ fontSize: 'var(--font-size-4xl)', fontWeight: 400, lineHeight: 1.1, marginBottom: '0.75rem' }}>The person behind the work.</h1>
      ...
      <section style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }} className="section-pad-md">
        ...
        <h2 className="font-serif section-title" style={{ fontSize: 'var(--font-size-3xl)', fontWeight: 400, marginBottom: '1.75rem', lineHeight: 1.15 }}>How I think about design.</h2>
          ...
          {pillars.map((p, i) => (
            <div key={p.num} className="pillar-grid" style={{ padding: '2.5rem 0', borderTop: '1px solid var(--color-border)', ...(i === pillars.length - 1 ? { borderBottom: '1px solid var(--color-border)' } : {}) }}>
              <div>
                ...
                <h3 className="font-serif" style={{ fontSize: 'var(--font-size-xl)', fontWeight: 400, lineHeight: 1.2 }}>{p.title}</h3>
              </div>
        ...
        <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }}>
          <div className="grid-2-wide" style={{ alignItems: 'start' }}>
            <div>
              ...
              <h2 className="font-serif" style={{ fontSize: 'var(--font-size-3xl)', fontWeight: 400, color: 'var(--color-bg)', lineHeight: 1.15, marginBottom: '1.75rem' }}>AI that earns its place on the team.</h2>
      ...
      <section style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }} className="section-pad-md">
        <div className="grid-2-wide" style={{ alignItems: 'start' }}>
          <div>
            ...
            <h2 className="font-serif section-title" style={{ fontSize: 'var(--font-size-3xl)', fontWeight: 400, lineHeight: 1.15, marginBottom: '1.75rem' }}>When I'm not designing.</h2>
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <div style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-sm)', padding: 'var(--space-8)', position: 'relative', overflow: 'hidden', width: '100%' }}>
              ...
              <h3 className="font-serif" style={{ fontSize: 'var(--font-size-2xl)', fontWeight: 400, lineHeight: 1.2, marginBottom: 'var(--space-3)' }}>Let's work together.</h3>
